...
public class FirstOrderHMMPOSTagger extends FirstOrderGeneralHMM implements POSTagger{
	...
	private DoubleArrayTrie dictionary = POSTaggingUtils.getDefaultDictionary();
	private WordNatureMapping wordNatureMapping = WordNatureMapping.getDefault();
	
	public FirstOrderHMMPOSTagger(int stateNum, int observationNum, double[] pi, double[][] transferProbability1,
	...
	public FirstOrderHMMPOSTagger(DoubleArrayTrie<String> dic, WordNatureMapping mapping) {
		super(mapping.getWordNatureNum(), dic.getKeySize());
		this.dictionary = dic;
